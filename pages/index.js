...
function App() {
  return (
    <div className="max-w-screen-xl mx-auto px-5">
      ...
      <div class="grid md:grid-cols-3 max-w-screen-lg mx-auto gap-10 mt-10 px-5">
        ...
        <div class="flex gap-4 items-start flex-col ">
          ...
          <div>
            ...
            <p class="mt-1 text-gray-500">
              {" "}
              You can make sure your website or app is highly
              performant with a built-in system to help you optimize.
            </p>
          </div>
        </div>
        <div class="flex gap-4 items-start flex-col ">
        ...
        <div class="grid md:grid-cols-2 gap-10 mt-10">
          <div class="flex gap-4 items-start">
            ...
            <div>
              ...
              <p class="mt-1 text-gray-500">
                {" "}
                You don't need to be an expert to customize this
          ...
          <div class="flex gap-4 items-start">
            ...
            <div>
              ...
              <p class="mt-1 text-gray-500">
                {" "}
                We make sure our plugins are working perfectly with
                all modern browsers available such as Chrome, Firefox,
                Safari.{" "}
              </p>
            </div>
          </div>
          ...
          <div class="flex gap-4 items-start">
            ...
            <div>
              ...
              <p class="mt-1 text-gray-500">
                {" "}
                This templatte is actively maintained by the core
                plugin team. We are working on fixing each of the
                issues reported.
              </p>
            </div>
          </div>
        ...
        <div class="flex flex-col justify-center">
          ...
          <div class="flex flex-wrap items-center justify-center gap-10 mt-2 md:justify-around">
            ...
            <div class="text-gray-400 ">
              <svg
                viewBox="0 0 248 31"
                class="w-auto h-5 text-slate-900 ">
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
