  ...
  return (
    <section class="bg-white dark:bg-gray-900">
      <div class="container xl:w-full w-11/12 mx-auto pt-16 overflow-y-hidden">
        <div class="xl:flex lg:flex md:flex sm:flex flex-wrap justify-around pt-20">
          <div class="xl:w-4/12 lg:w-2/4 md:w-2/5 sm:w-2/5 max-w-sm mb-8 border-b border-gray-300 dark:border-gray-700 pb-6">
          ...
          <div class="xl:w-4/12 lg:w-2/4 md:w-2/5 sm:w-2/5 mx-4 max-w-sm mb-8 border-b border-gray-300 dark:border-gray-700 pb-6">
            <div class="w-full rounded h-96">
              <img
