export default function ContactEntry(){
    return(
    <>
        <section id='contact' className="relative py-36 bg-gray-50 overflow-hidden">
        ...
        <div className="relative z-10 container px-4 mx-auto">
            ...
            <div className="w-full md:w-1/2 p-8">
                ...
                <label className="block mb-4">
                    ...
                    <input className="pl-12 pr-4 py-3 w-full text-gray-500 font-medium placeholder-gray-500 outline-none border border-gray-300 rounded-lg focus:ring focus:ring-indigo-300" id="contactInput3-1" type="text" placeholder="Name" />
                    </div>
                </label>
                <label className="block mb-4">
                    ...
                    <input className="pl-12 pr-4 py-3 w-full text-gray-500 font-medium placeholder-gray-500 outline-none border border-gray-300 rounded-lg focus:ring focus:ring-indigo-300" id="contactInput3-1" type="text" placeholder="Organization" />
                    </div>
                </label>
                <label className="block mb-4">
                    ...
                    <input className="pl-12 pr-4 py-3 w-full text-gray-500 font-medium placeholder-gray-500 outline-none border border-gray-300 rounded-lg focus:ring focus:ring-indigo-300" id="contactInput3-2" type="text" placeholder="Email address" />
                    </div>
                </label>
                <label className="block">
                    ...
                    <div className="md:inline-block">
                        <button className="py-4 px-9 w-full text-white font-semibold border border-indigo-700 rounded-xl shadow-4xl focus:ring focus:ring-indigo-300 bg-indigo-600 hover:bg-indigo-700 transition ease-in-out duration-200" type="button">Send Message</button>
                    </div>
                    </div>
                </label>
                </form>
